...
2. ضبط `NPM_TOKEN` واحد قابل لإعادة الاستخدام داخل مستودع النشر
...
إذا لم تكن npm provenance متاحة في إعدادات النشر الحالية، يمكن للـ workflow النشر من دون `--provenance`.
...
- تستخدم حزم الإضافات مسار نشر منفصلاً عن حزمة CLI الرئيسية
- تبقى لقطة plugin registry العامة متزامنة حتى يمكن تحديث بيانات الإضافات الرسمية بشكل مستقل عن نشر حزم الإضافات نفسها
