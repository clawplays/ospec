...
3. **Repair:** retry technical executor failures with the latest feedback; route task-review changes back to an implementation retry while finding IDs converge. Durable worker blockers are not redispatched.
