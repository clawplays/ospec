 ...
 */
export declare function parseContractVersion(raw: unknown): ContractVersion | null;
/** Whether `raw` parses to a version at or above `major.minor.patch`. */
export declare function contractVersionAtLeast(raw: unknown, major: number, minor: number, patch: number): boolean;
