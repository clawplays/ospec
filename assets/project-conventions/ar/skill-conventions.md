...
- لا يُقبل تغيير الكود وحده من دون تحديث `SKILL.md`
- لا تحشُ `SKILL.md` بمبررات التصميم التي تنتمي إلى وثائق التصميم
- يشرح `SKILL.md` ما هو موجود الآن، بينما تشرح وثائق التصميم سبب تصميمه بهذا الشكل
